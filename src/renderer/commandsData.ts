...
export const CODX_CATEGORIES: CommandCategory[] = [
  {
    id: 'codex-startup',
    name: '启动 / 编码',
    icon: '🚀',
...
export const TOOL_GROUPS: ToolGroup[] = [
  { id: 'cc', name: 'CC', icon: '🤖', categories: CC_CATEGORIES },
  { id: 'codex', name: 'Codex', icon: '💻', categories: CODX_CATEGORIES },
  { id: 'reasonix', name: 'Reasonix', icon: '🧠', categories: REASONIX_CATEGORIES },
];
